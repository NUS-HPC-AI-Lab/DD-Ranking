...
args.train_dir = f"../datasets/{args.subset}/train/"
args.val_dir = f"../datasets/{args.subset}/val/"
...
if args.subset in [
    ...
    args.val_ipc = 1000
    args.input_size = 32
    args.train_dir = "./cifar10/train/"
    args.val_dir = "./cifar10/val/"
    ...
    args.val_ipc = 100
    args.input_size = 32
    args.train_dir = "./cifar100/train/"
    args.val_dir = "./cifar100/val/"
    ...
    args.val_ipc = 50
    args.input_size = 64
    args.train_dir = "../datasets/tiny-imagenet-200/train/"
    args.val_dir = "../datasets/tiny-imagenet-200/val/"

args.nclass = len(args.classes)

# set up batch size
if args.re_batch_size == 0:
    if args.ipc == 50 or args.ipc == 100:
