...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./distilled/CIFAR10_ZCA/IPC10/images.pt', help='dataset')
    parser.add_argument('--label_dir', type=str, default='./distilled/CIFAR10_ZCA/IPC10/labels.pt', help='dataset')
    parser.add_argument('--lr_dir', type=str, default='./distilled/CIFAR10_ZCA/IPC10/lr.pt', help='dataset')
